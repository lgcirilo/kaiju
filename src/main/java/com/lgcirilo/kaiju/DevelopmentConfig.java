...
//                User gui = new User("guiguid.cirilo@gmail.com", "Guilherme");
...
//                taskRepo.save(new Task(gui, "Estudar"));
//                taskRepo.save(new Task(gui, "Fazer tarefa valendo 3 pontos"));
//                taskRepo.save(new Task(gui, "Brincar"));
//                taskRepo.save(new Task(gui, "Jogar fortnite"));
//                taskRepo.save(new Task(gui, "Ler gibi"));
//                taskRepo.save(new Task(gui, "Dormir"));
//            }
//        };
//    }
//
